// Beside the code because it drives the heartbeat directly: the protocol's
// own timing is not something an application sets.
...
import { sharedWorkerChannel, sharedWorkerHub } from '#link'
import type { SharedScope } from '#link'
import type { Wire } from '#link'
import { wirePair } from '#link'
import { leadOrFollow, webLocks } from '#link'
